"""predicting_heart_rate URL Configuration
...
from predicting_heart_rate import settings
...
urlpatterns = [
    ...
    url(r'^Search_HeartRate_DataSets/$', remoteuser.Search_HeartRate_DataSets, name="Search_HeartRate_DataSets"),
    ...
    url(r'^Find_Stress_Level_Accuracy/$', serviceprovider.Find_Stress_Level_Accuracy, name="Find_Stress_Level_Accuracy"),
    url(r'^View_Stress_Level_Details/$', serviceprovider.View_Stress_Level_Details, name="View_Stress_Level_Details"),
    url(r'^Train_View_HeartRate_DataSets_Details/$', serviceprovider.Train_View_HeartRate_DataSets_Details, name="Train_View_HeartRate_DataSets_Details"),
